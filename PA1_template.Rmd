...
```
The mean is `r meansteps` steps.
<br>
The median is `r mediansteps` steps.
<br>
...
And the answer is `r maxstepint`.
...
```
And that total number is `r numrowswithna`.
...
```
The mean is `r meanstepsnona` steps.
<br>
The median is `r medianstepsnona` steps.
<br> 
<br> 
